...
public class TimelineListAdapter extends BaseAdapter {
    ...
    public TimelineListAdapter(ArrayList<Post_Song> songlist, int layout, Context context) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(row ==null){
            ...
            holder.artist = (TextView)row.findViewById(R.id.tartist);
            holder.name = (TextView)row.findViewById(R.id.tuser_name);
            holder.time = (TextView)row.findViewById(R.id.ttime);
            holder.title = (TextView)row.findViewById(R.id.tsong_title);
            holder.song_pic = (LinearLayout)row.findViewById(R.id.ttrack_pic);
            holder.userImage =(ImageView) row.findViewById(R.id.tuser_pic);
            holder.stream = (TextView)row.findViewById(R.id.tstreamurl);
            holder.duration = (TextView)row.findViewById(R.id.tduration);
            holder.id = (TextView)row.findViewById(R.id.tsid);
            row.setTag(holder);
        }else{
